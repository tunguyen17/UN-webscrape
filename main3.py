...
def get_partners():
    ...
    next_index = home_right_raw_lst.index('Ocean Basins')                     if len(r.history) and 'the ocean conference' in soup.title.text.lower()                     else home_right_raw_lst.index('Countries')
...
data_file.write('Title\tGoals\tPartners\tDescription\tResources\tTime_frame\tCountries\tHashtag\n')
